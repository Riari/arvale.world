...
export class createForumTables1535579356448 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "forum_thread" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "lockedAt" TIMESTAMP DEFAULT NULL, "stickiedAt" TIMESTAMP DEFAULT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "categoryId" integer, "authorId" integer, CONSTRAINT "PK_a531f692372aac738265f6dff13" PRIMARY KEY ("id"))`);
